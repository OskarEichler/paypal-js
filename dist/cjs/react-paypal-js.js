...
var hasInvalidExpirationDate = function (registerTypes) {
    var hasDate = registerTypes.includes(exports.PAYPAL_HOSTED_FIELDS_TYPES.EXPIRATION_DATE);
    var hasMonth = registerTypes.includes(exports.PAYPAL_HOSTED_FIELDS_TYPES.EXPIRATION_MONTH);
    var hasYear = registerTypes.includes(exports.PAYPAL_HOSTED_FIELDS_TYPES.EXPIRATION_YEAR);
...
var PayPalHostedFieldsProvider = function (_a) {
    ...
    return (React.createElement("div", null, isEligible ? (React.createElement(PayPalHostedFieldsContext.Provider, { value: {
