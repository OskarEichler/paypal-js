 ...
 */
var hasInvalidExpirationDate = function (registerTypes) {
  var hasDate = registerTypes.includes(PAYPAL_HOSTED_FIELDS_TYPES.EXPIRATION_DATE);
  var hasMonth = registerTypes.includes(PAYPAL_HOSTED_FIELDS_TYPES.EXPIRATION_MONTH);
  var hasYear = registerTypes.includes(PAYPAL_HOSTED_FIELDS_TYPES.EXPIRATION_YEAR);
...
var hasDefaultChildren = function (registerTypes) {
  if (!registerTypes.includes(PAYPAL_HOSTED_FIELDS_TYPES.NUMBER) || !registerTypes.includes(PAYPAL_HOSTED_FIELDS_TYPES.CVV) || hasInvalidExpirationDate(registerTypes)) {
...
var PayPalHostedFieldsProvider = function (_a) {
  ...
  useEffect(function () {
    ...
    var hostedFields = (_b = getPayPalWindowNamespace$1(options[SDK_SETTINGS.DATA_NAMESPACE])) === null || _b === void 0 ? void 0 : _b.HostedFields;
    if (!hostedFields) {
      ...
      return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              _b.trys.push([0, 2,, 3]);
              return [4 /*yield*/, cardFieldsInstance === null || cardFieldsInstance === void 0 ? void 0 : cardFieldsInstance.teardown()];
            case 1:
              _b.sent();
              return [3 /*break*/, 3];
            case 2:
  ...
  return React.createElement("div", null, isEligible ? React.createElement(PayPalHostedFieldsContext.Provider, {
    value: {
